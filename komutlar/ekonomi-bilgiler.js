      ...
      if(!hesapismi) {
        ...
        if(hesapdurumu) {
          if(hesapismi) {
            ...
            .setColor(client.ekoayarlar.renk)
            .addField(`Hesap İsmi:`, ` ${hesapismi}`)
.addField(` Bakiye:`,`${bakiye}`)
.addField(`Hesap Oluşturma Tarihi:`, `**${hesaptarihay}/ ${hesaptarihgün}/${hesaptarihyıl}** gününde hesabın oluşturuldu!`)
