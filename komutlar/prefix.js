...
module.exports.run = async (client, message, args) => {
  ...
  if (arg === "!!") return message.reply("Botun orjinal ön ekini özel ön ek olarak ayarlayamazsın. \nEğer ön ekin botun normal ön eki olmasını istiyorsan `f?` yerine `varsayılan` yazarak ön-ek komutunu kullan!")
  ...
  if (arg === "varsayılan") {
    ...
    .setDescription("Ön-Ek sıfırlanıp `f?` olarak ayarlanmıştır!")
