...
exports.run = async (client, message, args) => {
  ...
  if (uwu) {
    try {
      ...
      message.channel.send("<a:yukleniyor:637525668573478912> Kasa Açılıyor.").then(async msg => {
        const icindekiler = require(`.././icindekiler${kasaid}`)
        setTimeout(() => {
          msg.edit("<a:yukleniyor:637525668573478912> Kasa Açılıyor..");
        }, 1000);
        setTimeout(() => {
          msg.edit("<a:yukleniyor:637525668573478912> Kasa Açılıyor...");
        }, 2000);
        ...
        setTimeout(() => {
          msg.edit("<:rf_check:642475879615823882> Kasanız Açıldı!");
          msg.delete()
        }, 5000);
        setTimeout(() => {
      ...
      //const activity = activitys[Math.floor(Math.random() * activitys.length)];
        ...
        message.channel.send('<:hata:637685816197382165> Bir hata var!')
      }
  }
}
