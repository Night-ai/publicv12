...
exports.run = async (client, message, args) => {
    ...
    if (daily !== null && timeout - (Date.now() - daily) > 0) {
        ...
        message.channel.send(`<:hata:637685816197382165> Günlük ödülünü tekrar alabilmek için **${time.hours} saat ${time.minutes} dakika ${time.seconds} saniye** beklemelisin.`)
    } else {
...
exports.conf = {
    enabled: true,
    guildOnly: false,
    aliases: ['günlük-para', 'günlük-ödül'],
    permLevel: 0,
    katagori: "Ekonomi"
}
